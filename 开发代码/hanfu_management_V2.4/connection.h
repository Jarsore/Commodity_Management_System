...
static bool createConnection()
{
    ...
    */
    ...
    //query.exec("insert into brand values('01', '明华堂', '男装', 369, 50, 10, 40, 'D:\\\\Qt\\\\files\\\\hanfu_management\\\\images\\\\image1.jpg')");
    // 其他插入语句也类似地增加图片路径

    query.exec("insert into brand values('01', '明华堂', '男装', 369, 50, 10, 40,'D:\\\\Qt\\\\files\\\\hanfu_management\\\\images\\\\image1.jpg')");
    query.exec("insert into brand values('02', '晴山木语国风馆', '男装', 3499, 20, 5, 15, 'D:\\\\Qt\\\\files\\\\hanfu_management\\\\images\\\\image2.jpg')");
    query.exec("insert into brand values('03', '明华堂', '女装', 419, 80, 40, 40, 'D:\\\\Qt\\\\files\\\\hanfu_management\\\\images\\\\image3.jpg')");
    query.exec("insert into brand values('04', '绣罗衣', '女装', 399, 40, 10, 30, 'D:\\\\Qt\\\\files\\\\hanfu_management\\\\images\\\\image4.jpg')");
    query.exec("insert into brand values('05', '寻秦', '女装', 289, 60, 10, 50, 'D:\\\\Qt\\\\files\\\\hanfu_management\\\\images\\\\image5.jpg')");
    query.exec("insert into brand values('06', '西洲曲原创汉服', '女装', 279, 70, 20, 50, 'D:\\\\Qt\\\\files\\\\hanfu_management\\\\images\\\\image6.jpg')");
