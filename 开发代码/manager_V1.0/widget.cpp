...
// 新商品品牌改变时
void Widget::on_newBrandLineEdit_currentTextChanged(const QString &str)
{
    if (str == "") {
...
void Widget::on_newOkBtn_clicked()
{
    ...
    QString brand = ui->newBrandLineEdit->currentText();   //此处原为QString brand = ui->newBrandLineEdit->text();
